...
const Footer = () => {
  ...
  return (
    <div className={`flex flex-col sm:flex-row py-4 px-4 border-t-2 shadow-t-sm justify-between items-center ${darkMode && "bg-[#02000f] text-[#eee] border-none shadow-none"}`}>
